    ...
    options = {
      ...
      roomLocking = lib.mkOption {
        ...
        description = ''
          ...
          and cannot be entered by lib.anyone but the creator
        '';
      };
      ...
      tombstones = lib.mkOption {
        ...
        description = ''
          ...
          lib.anyone who was not in the room at the time it was destroyed
    ...
    environment.etc."prosody/prosody.cfg.lua".text =
      ...
      ${lib.concatMapStrings (muc: ''
        Component ${toLua muc.domain} "muc"
            ...
            muc_room_default_history_lib.length = ${toLua muc.roomDefaultHistoryLength}
